...
# with taxonomy: initiative plus canonical design/workflow directories,
# creates the six docs/<tier>/ directories, and renders four outputs in
# docs/prompts/ per the Slice 5 plan §1:
#
...
#
# Scaffolds the initiative taxonomy described by the HOTL initiative templates.
...
Behavior:
  ...
  - Sets designs_dir: docs/designs and workflows_dir: docs/plans.
...
echo ""
echo "Next: edit docs/designs/${SLUG}.md via /hotl:brainstorm (scope: initiative), then create phase designs in docs/designs/ and workflows in docs/plans/."
